...
const Education = () => {
  ...
  const getAllEducation = async () => {
    await axios
      .get(`${import.meta.env.VITE_BASE_URL}/topics/getAll`)
      .then((res) => {
        setGetone(res.data);
      });
  };
  ...
  const updateItem = async () => {
    ...
    await axios
      .put(`${import.meta.env.VITE_BASE_URL}/topics/updateItem/${itemId}`, body)
      .then((res) => {
        if (res.status === 200) {
          Swal.fire({
            position: "center",
  ...
  const updateGroupId = async () => {
    ...
    await axios
      .put(
        `${import.meta.env.VITE_BASE_URL}/topics/updateGroup/${GroupId}`,
        body
      )
      .then((res) => {
        if (res.status === 200) {
  ...
  const addGroup = async () => {
    const body = { topic: nameGroup };
    await axios
      .post(`${import.meta.env.VITE_BASE_URL}/topics/addGroup`, body)
      .then((res) => {
        if (res.status === 200) {
          Swal.fire({
            position: "center",
  ...
  const updateEducation = async () => {
    ...
    await axios
      .put(`${import.meta.env.VITE_BASE_URL}/education/${eId}`, body)
      .then((res) => {
        if (res.status === 200) {
  ...
  const DeleteItemId = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`${import.meta.env.VITE_BASE_URL}/topics/deleteItem/${id}`)
          .then((res) => {
            if (res.status === 200) {
              Swal.fire({
                position: "center",
  ...
  const DeleteEducation = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        axios
          .delete(`${import.meta.env.VITE_BASE_URL}/education/${id}`)
          .then((res) => {
            if (res.status === 200) {
              Swal.fire({
                position: "center",
  ...
  const DeleteGroup = async (Id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`${import.meta.env.VITE_BASE_URL}/topics/deleteGroup/${Id}`)
          .then((res) => {
            if (res.status === 200) {
              Swal.fire({
                position: "center",
  ...
  const handelSubmit = async (event) => {
    ...
    if (itemId) {
      ...
      await axios
        .post(`${import.meta.env.VITE_BASE_URL}/topics/addItem`, body)
        .then((res) => {
          if (res.status === 200) {
            Swal.fire({
              position: "center",
